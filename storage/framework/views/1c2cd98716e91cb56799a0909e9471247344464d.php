...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="/<?php echo e(trim(config('admin.prefix'), '/')); ?>" class="logo">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo e(Admin::url('auth/setting')); ?>" class="btn btn-default btn-flat"><?php echo e(trans('admin::lang.setting')); ?></a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo e(Admin::url('auth/logout')); ?>" class="btn btn-default btn-flat"><?php echo e(trans('admin::lang.logout')); ?></a>
                            </div>
                        </li>
                    </ul>
                </li>
