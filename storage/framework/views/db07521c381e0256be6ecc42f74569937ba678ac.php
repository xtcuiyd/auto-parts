        ...
        <form method="post" action="<?php echo e($action); ?>" id="scaffold" pjax-container>
            ...
            <div class="box-body">
                ...
                <table class="table table-hover" id="table-fields">
                    ...
                    <?php if(old('fields')): ?>
                        <?php foreach(old('fields') as $index => $field): ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <select style="width: 150px" name="fields[<?php echo e($index); ?>][key]">
                                        <?php /*<option value="primary">Primary</option>*/ ?>
                ...
                <?php /*<table class="table table-hover" id="model-relations">*/ ?>
                    <?php /*<tbody>*/ ?>
                    <?php /*<tr>*/ ?>
                        <?php /*<th style="width: 200px">Relation name</th>*/ ?>
                        <?php /*<th>Type</th>*/ ?>
                        <?php /*<th>Related model</th>*/ ?>
                        <?php /*<th>forignKey</th>*/ ?>
                        <?php /*<th>OtherKey</th>*/ ?>
                        <?php /*<th>With Pivot</th>*/ ?>
                        <?php /*<th>Action</th>*/ ?>
                    <?php /*</tr>*/ ?>
                    <?php /*</tbody>*/ ?>
                <?php /*</table>*/ ?>

                <?php /*<hr style="margin-top: 0;"/>*/ ?>

                <?php /*<div class='form-inline margin' style="width: 100%">*/ ?>

                    <?php /*<div class='form-group'>*/ ?>
                        <?php /*<button type="button" class="btn btn-sm btn-success" id="add-model-relation"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add relation</button>*/ ?>
                    <?php /*</div>*/ ?>
