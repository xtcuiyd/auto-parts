...
<div class="box box-primary">
    ...
    <div class="box-footer with-border">
        ...
        <div style="margin-bottom: 10px;">
            ...
            <?php foreach($commands['groups'] as $group => $command): ?>
            <div class="btn-group dropup">
                <button type="button" class="btn btn-default btn-flat"><?php echo e($group); ?></button>
                <button type="button" class="btn btn-default btn-flat dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <span class="caret"></span>
                    <span class="sr-only">Toggle Dropdown</span>
                </button>
                <ul class="dropdown-menu" role="menu">
                    <?php foreach($command as $item): ?>
                    <li><a href="#" class="loaded-command"><?php echo e($item); ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
            <?php endforeach; ?>
            ...
            <div class="btn-group dropup">
                ...
                <ul class="dropdown-menu" role="menu">
                    <?php foreach($commands['others'] as $item): ?>
                    <li><a href="#" class="loaded-command"><?php echo e($item); ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
