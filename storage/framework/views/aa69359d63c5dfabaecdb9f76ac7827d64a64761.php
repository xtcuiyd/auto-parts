   ...
   <div class="container">
     ...
     <div class="about-grids">
       <div class="col-md-4 about-pic">
          <img src="<?php echo e(asset('assets/images/pic3.jpg')); ?>" class="img-responsive" alt=""/>
       </div>
     ...
     <div class="works">
        ...
        <div class="grid_4">
        <div class="text1">
               <img src="<?php echo e(asset('assets/images/t1.jpg')); ?>" alt="">
        ...
        <div class="grid_4">
         <div class="text1">
               <img src="<?php echo e(asset('assets/images/t2.jpg')); ?>" alt="">
               <h4>Phasellus scipitilifen lus.</h4>
              <p>Kuspendisse laoreet augue iderti wer  interdum merti oremolo lectusto odio, sedorolu fringilla estero libero. </p>
            </div>
        </div>
        ...
        <div class="text1">
               <img src="<?php echo e(asset('assets/images/t3.jpg')); ?>" alt="">
               <h4>Phasellus scipitilifen lus.</h4>
              <p>Kuspendisse laoreet augue iderti wer  interdum merti oremolo lectusto odio, sedorolu fringilla estero libero. </p>
            </div>
        </div>      
        <div class="grid_4">         
            <div class="text1">
               <img src="<?php echo e(asset('assets/images/t4.jpg')); ?>" alt="">
               <h4>Phasellus scipitilifen lus.</h4>
              <p>Kuspendisse laoreet augue iderti wer  interdum merti oremolo lectusto odio, sedorolu fringilla estero libero. </p>
            </div>            
         </div>
